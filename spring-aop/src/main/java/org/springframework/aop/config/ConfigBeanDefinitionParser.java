...
class ConfigBeanDefinitionParser implements BeanDefinitionParser {
	...
	public BeanDefinition parse(Element element, ParserContext parserContext) {
		...
		//向BeanFactory中注册<org.springframework.aop.config.internalAutoProxyCreator,AspectJAwareAdvisorAutoProxyCreator.class>
		...
		for (Element elt : childElts) {
			...
			if (POINTCUT.equals(localName)) {
				...
				//向BeanFactory中注册<org.springframework.aop.aspectj.AspectJPointcutAdvisor#n > <pointcut-id, AspectJExpressionPointcut>
