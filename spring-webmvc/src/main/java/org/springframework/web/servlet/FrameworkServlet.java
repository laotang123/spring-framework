...
public abstract class FrameworkServlet extends HttpServletBean implements ApplicationContextAware {
	...
	/**
	 * 监听ContextRefreshEvent事件，触发onRefresh操作。从BeanFactory中获取九大BeanDefinition并进行实例化
	 * TODO：九大组件的BeanDefinition是什么时候注入到BeanFactory中的？，ContextRefreshEvent事件什么时候触发？
